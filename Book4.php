		...
		<div id="signup" class="container"> <hr>
			...
			<form action="loginvalid.php" method="post">
			  ...
			  <input type="name" placeholder="Full Name" name="F2name" oninput="setInit(0);">
				...
				<br>
			  <h3>Passenger 3</h3>
			  <input type="name" placeholder="Full Name" name="F3name" oninput="setInit(0);">
			    <input type="name" placeholder="Age" name="age3" oninput="setInit(0);"><br>
			    <h2><input type="radio" id="male" name="gender3" value="male">
				<label for="male">Male  &nbsp &nbsp &nbsp&nbsp &nbsp     </label> 
				<input type="radio" id="female" name="gender3" value="female">
				<label for="female">Female</label><br></h2>
				<h3>Passenger 4</h3>
			  <input type="name" placeholder="Full Name" name="F4name" oninput="setInit(0);">
			    <input type="name" placeholder="Age" name="age4" oninput="setInit(0);"><br>
			    <h2><input type="radio" id="male" name="gender4" value="male">
				<label for="male">Male  &nbsp &nbsp &nbsp&nbsp &nbsp     </label> 
